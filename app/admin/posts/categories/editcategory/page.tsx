...
export default function EditCategoryPage(categoryId: string): React.JSX.Element {
 let category: Category = { id: '', name: '', slug: '', description: '' };

React.useEffect(() => {
  const loadCategory = async () => {
    const result = await fetchCategories(categoryId);
