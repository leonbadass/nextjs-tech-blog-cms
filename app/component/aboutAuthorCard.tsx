...
export default async function AboutAuthorCard({authorId}: AboutAuthorCardProps): Promise<JSX.Element> {
    ...
    return (<div className="border-y-2 border-[#ff6b35] py-10">
        ...
        <div>
            ...
            <div dangerouslySetInnerHTML={{__html:author.bio}} className="text-lg tracking-wide pb-2"/>
            <Link href={`/authors/${author.slug}`}
            className="font-semibold text-lg text-[#007bff] tracking-wide hover:underline hover:text-[#ff6b35]"
